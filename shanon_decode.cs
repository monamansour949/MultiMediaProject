...
namespace MMPro
{
    public partial class shanon_decode : Form
    {
        public shanon_decode(String input)
        {
            InitializeComponent();
            textBox1.Text = input;
        }
        ...
        private void shanon_decode_Load(object sender, EventArgs e)
        {
