...
namespace MMPro
{
    public partial class adabtive_huffman : Form
    {
        public adabtive_huffman(string input)
        {
            InitializeComponent();
            textBox1.Text = input;
        }
        ...
        private void adabtive_hulffman_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void adabtive_huffman_Load(object sender, EventArgs e)
        {
